...
@Component({
  selector: 'app-tempyhume4',
  templateUrl: './tempyhume4.component.html',
  styleUrl: './tempyhume4.component.css',
  providers: [MessageService]
})
export class TEMPYHUME4Component implements OnInit, OnDestroy {
  ...
  initializeChart(): void {
    this.chart = new Chart('combinedChart3', {
      type: 'line',
      data: {
