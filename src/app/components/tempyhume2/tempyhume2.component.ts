...
@Component({
  selector: 'app-tempyhume2',
  templateUrl: './tempyhume2.component.html',
  styleUrl: './tempyhume2.component.css',
  providers: [MessageService]
})
export class TEMPYHUME2Component implements OnInit, OnDestroy {
  ...
  initializeChart(): void {
    this.chart = new Chart('combinedChart1', {
      type: 'line',
      data: {
  ...
  fetchTemperatureData(): void {
    this.sensorDataService.getTemperature2().subscribe(data => {
