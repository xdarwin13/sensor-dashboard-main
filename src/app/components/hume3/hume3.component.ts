...
@Component({
  selector: 'app-hume3',
  templateUrl: './hume3.component.html',
  styleUrl: './hume3.component.css'
})
export class HUME3Component implements OnInit, OnDestroy {
  humidityData: number[] = [];
  chartLabels: string[] = [];
  ...
  initializeChart(): void {
    this.chart = new Chart('humidityChart2', {
      type: 'line',
      data: {
