...
@Component({
  selector: 'app-hume4',
  templateUrl: './hume4.component.html',
  styleUrl: './hume4.component.css'
})
export class HUME4Component implements OnInit, OnDestroy {
  humidityData: number[] = [];
  chartLabels: string[] = [];
  ...
  initializeChart(): void {
    this.chart = new Chart('humidityChart3', {
      type: 'line',
      data: {
