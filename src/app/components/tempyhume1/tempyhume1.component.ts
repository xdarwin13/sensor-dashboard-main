...
@Component({
  selector: 'app-tempyhume1',
  templateUrl: './tempyhume1.component.html',
  styleUrl: './tempyhume1.component.css',
  providers: [MessageService]
})
export class TEMPYHUME1Component implements OnInit, OnDestroy {
